...
import UploadModal from "../../../images/components/UploadModal";
            ...
            {(field) => (
               <div className="flex flex-col gap-1">
                  ...
                  <button
                     ...
                     className={inputClass + " text-left text-(--text-faint)"}
                  >
                     + {field.state.value ? "Cambiar imagen" : "Agregar imagen"}
                  </button>
                  {field.state.value && (
                     <div className="flex items-center gap-2 mt-1">
                        <img src={field.state.value} alt="" className="w-8 h-8 object-cover rounded" />
                        <span className="truncate flex-1 text-xs text-(--text-muted)">{field.state.value}</span>
                        <button
                           type="button"
